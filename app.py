...
lineaccesstoken = '4qFhwHG2f97fprLI1B5cPZYgSDz63bZyd5WMHb1X1+3rjkt73Cp6xB5b1lgp33U00dRpyCAvnEZXoCXIPXIauewtNX/Z44Onx+VMVWvkPl1vOD1l3wb2zEAg6o6HcAE0WQBj3U4kzzVw3cX39VRx6wdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        elif (msg == "เธอชิปคู่ไหน")  :
            replyObj = TextSendMessage(text="เราเป็นแจมเหรินชิปเป้อ")
        elif (msg == "เค้าเลิกกันแล้วไม่ใช่หรอ")  :
            replyObj = TextSendMessage(text="แกแรงมาก!! ตบปาก")
        else :
            replyObj = TextSendMessage(text=msg)
        line_bot_app.reply_message(rtoken, replyobj)    
     elif msgType == "image":
        try:
